...
- Create Angular project with ng: `ng new WebApiAngular.Client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`WebApiAngular.Client.esproj`).
