...
- Create Angular project with ng: `ng new onboardingtesterhelper.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`onboardingtesterhelper.client.esproj`).
